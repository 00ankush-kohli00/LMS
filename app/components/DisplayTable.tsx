  ...
  return (
    <div className=" flex flex-col p-10 h-[fi%] max-w-6xl max-md:p-4 max-md:pt-10">
      ...
      <div className="flex flex-col pt-5 h-fit">
        ...
        {/* <div className="w-full rounded-md h-[80%] bg-yellow-300 overflow-auto "> */}
        <ScrollArea className="rounded-md border h-[70%]">
          <table
            {...getTableProps()}
            className="w-full text-left border-2 rounded-md overflow-x-auto overflow-y-auto"
          >
            <thead>
